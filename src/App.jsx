...
const MinnieBirthdayInvite = () => {
  ...
  const [countdownComplete, setCountdownComplete] = useState(initialTimeLeftState.isComplete);
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      const sections = ['home', 'details', 'venue', 'dress', 'menu', 'rsvp'];
  ...
  if (loading) {
    return (
      <div className="fixed inset-0 flex flex-col items-center justify-center bg-black">
        ...
        <h2 className="text-2xl font-bold text-pink-500 mb-2">Welcome to Minnie's World</h2>
        <p className="text-white text-lg">Getting everything ready...</p>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gradient-to-b from-black to-gray-900 text-white">
      ...
      {showConfetti && (
        <Confetti
          ...
          gravity={0.15}
          colors={['#ec4899', '#f472b6', '#f9a8d4', '#ffffff', '#fde68a', '#fcd34d']}
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center">
              ...
              >
                ...
                /> */}
                <span className="font-cursive text-2xl font-bold text-pink-500">Minnie's World</span>
              </motion.div>
            </div>
            ...
            <div className="hidden md:block">
              <div className="flex items-center space-x-4">
                {['home', 'details', 'venue', 'dress', 'menu', 'rsvp'].map((section) => (
                  <motion.button
                    key={section}
      ...
      {/* Hero Section */}
      <section id="home" className="relative min-h-screen pt-16 pb-12 flex flex-col items-center justify-center overflow-hidden">
        ...
        <div className="z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="mb-8">
            ...
            >
              Sunset Soirée — <span className="text-pink-400">Crowned & Cozy</span>
            </motion.h2>
          ...
          >
            <h3 className="text-xl md:text-2xl font-semibold mb-6">
              {countdownComplete ? "The celebration is here!" : "Counting down to the celebration"}
            </h3>
            ...
            {countdownComplete ? (
              ...
              >
                <h4 className="text-2xl font-bold text-pink-300 mb-3">It's Party Time!</h4>
                <p className="text-lg text-white mb-4">
                  Join us today at 5 PM for Minnie's spectacular birthday celebration!
                </p>
              ...
              <div className="flex flex-wrap justify-center gap-4">
                {Object.entries(timeLeft).map(([unit, value]) => (
                  ...
                  >
                    ...
                    <div className="text-xs md:text-sm text-gray-300">{unit}</div>
                  </motion.div>
                ))}
              </div>
            )}
      ...
      <section id="details" className="py-16 md:py-24 bg-gradient-to-b from-gray-900 to-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-pink-500 mb-6">Event Details</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            >
              <p className="text-xl italic text-pink-300 mb-6">
                "I'm so excited to invite you to my post-crown birthday celebration that's all about warmth, gratitude, deep laughs, magical memories, and stepping into a new chapter with YOU!"
              </p>
              
              <p className="text-gray-300 mb-6">
                This isn't just any party... it's a glimpse into my world—a space of elegance, intention, joy, and fun. Through this invite, you'll find all the important info and a few delightful surprises to get you in the mood. Let's create memories that'll linger long after the stars come out ✨
              </p>
              ...
              <div className="bg-pink-900 bg-opacity-30 p-6 rounded-lg border border-pink-800 mt-8">
                ...
                <p className="text-lg mb-2">
                  <span className="font-semibold text-pink-300">Date:</span> 26th April 2025
                </p>
                <p className="text-lg mb-2">
                  <span className="font-semibold text-pink-300">Time:</span> 5 PM until late
                </p>
                ...
                <p className="text-lg">
                  <span className="font-semibold text-pink-300">WhatsApp/Call:</span> +27 (83) 528-1746
                </p>
              </div>
            </motion.div>
          ...
          >
            <h3 className="text-2xl font-cursive font-bold text-pink-400 mb-4">A Heartfelt Note to My Loved Ones Far Away 🌍</h3>
            <p className="text-gray-300 mb-4">
              As I prepare to step into this next chapter, I can't help but feel a little tug on my heart knowing that some of you won't be able to join us in person. Even though we may be miles apart, please know that your love, your energy, and your presence in my life mean the world to me.
            </p>
            <p className="text-gray-300 mb-4">
              I understand travel isn't always possible—but you are still part of this story, and I want you to feel included every step of the way.
            </p>
            <p className="text-gray-300 mb-4">
              I'll be sharing special moments from the evening—photos, videos, and even some live snippets—so you can experience the celebration with us in spirit. My deepest hope is that these glimpses make you feel right here with us, wrapped in all the joy and beauty of the night.
            </p>
            <p className="text-gray-300 mb-4">
              Thank you for your love, your prayers, and for always being part of my journey. I'll carry your spirit with me as we celebrate this divine milestone.
            </p>
      ...
      {/* Venue Section */}
      <section id="venue" className="py-16 md:py-24 bg-gradient-to-b from-black to-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            ...
            className="text-center mb-12"
          >
            <h2 className="text-3xl md:text-4xl font-bold text-pink-500 mb-6">Venue & Directions</h2>
            <div className="w-24 h-1 bg-pink-500 mx-auto mb-8"></div>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            >
              <h3 className="text-2xl font-bold mb-6">Bakoven, Cape Town</h3>
              <p className="text-gray-300 mb-4">
                Join us for an unforgettable evening at a stunning venue with ocean views, nestled in beautiful Bakoven.
              </p>
              ...
              <div className="bg-pink-900 bg-opacity-30 p-6 rounded-lg border border-pink-800 mt-4">
                ...
                <div className="flex items-center mb-4">
                  ...
                  <h4 className="text-lg font-semibold">Parking Information</h4>
                </div>
                <p className="text-gray-300 ml-8">
                  Limited street parking is available on Hoopoe Avenue and surrounding streets. Consider carpooling or using ride-sharing services.
                </p>
              </div>
              
              <button
                onClick={() => window.open('https://www.google.com/maps/search/?api=1&query=16+Hoopoe+Avenue+Bakoven+Cape+Town', '_blank')}
      ...
      {/* Dress Code Section */}
      <section id="dress" className="py-16 md:py-24 bg-gradient-to-b from-gray-900 to-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            ...
            className="text-center mb-12"
          >
            <h2 className="text-3xl md:text-4xl font-bold text-pink-500 mb-6">Dress Code</h2>
            <div className="w-24 h-1 bg-pink-500 mx-auto mb-8"></div>
            <p className="text-xl text-pink-300 font-semibold">Serving Looks, Minnie Style 💅🏾🖤🎀</p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              <div className="p-6">
                <h3 className="text-xl font-bold text-center mb-4">For the Ladies</h3>
                <div className="w-16 h-1 bg-pink-500 mx-auto mb-6"></div>
                <p className="text-center text-gray-300 mb-4">
                  Come through in your heels, elegant dresses or blouses in pink or black.
                </p>
            ...
            >
              <div className="p-6">
                <h3 className="text-xl font-bold text-center mb-4">For the Gentlemen</h3>
                <div className="w-16 h-1 bg-pink-500 mx-auto mb-6"></div>
                <p className="text-center text-gray-300 mb-4">
                  Sneakers are welcome, but let's keep it classy. Pink or black only.
                </p>
            ...
            >
              <div className="p-6">
                <h3 className="text-xl font-bold text-center mb-4">PJ Slumber Party</h3>
                <div className="w-16 h-1 bg-pink-500 mx-auto mb-6"></div>
                <p className="text-center text-gray-300 mb-4">
                  Staying for the after party? Slip into your PJs, unwind, and enjoy some cozy chaos.
                </p>
                <p className="text-center text-pink-300">
                  <span className="font-semibold">P.S.</span> There's a little gift waiting for you!
                </p>
              </div>
              {/* <div className="h-64 overflow-hidden">
          ...
          >
            <p className="text-lg italic text-gray-300">
              "I don't wanna fight, okay?! 😭 Let's all look cute for the camera. Be you."
            </p>
          </motion.div>
        </div>
      </section>
      ...
      {/* Menu Section */}
      <section id="menu" className="py-16 md:py-24 bg-gradient-to-b from-black to-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            ...
            className="text-center mb-12"
          >
            <h2 className="text-3xl md:text-4xl font-bold text-pink-500 mb-6">Menu</h2>
            <div className="w-24 h-1 bg-pink-500 mx-auto mb-8"></div>
          </motion.div>
...
<motion.div
            ...
            >
              <div className="bg-pink-900 bg-opacity-30 p-8 rounded-lg border border-pink-800">
                <h3 className="text-2xl font-cursive font-bold text-center text-pink-400 mb-6">Pink Hour</h3>
                
                <div className="mb-8">
                  <h4 className="text-xl font-bold text-center mb-4">STARTER</h4>
                  <p className="text-center text-gray-300">
                    Sausage rolls, loaded potato skins, Jalapeño Poppers, Crackers, Cheese or Fruit Board
                  </p>
                </div>
                
                <div className="mb-8">
                  <h4 className="text-xl font-bold text-center mb-4">MAIN</h4>
                  <p className="text-center text-gray-300">
                    Grilled chicken accompanied by roasted potatoes and a side of seasonal vegetables
                  </p>
                </div>
                
                <div>
                  <h4 className="text-xl font-bold text-center mb-4">DESSERT</h4>
                  <p className="text-center text-gray-300">
                    Chocolate and Vanilla Cake, Caramel Popcorn, Cupcakes
                  </p>
                </div>
                
                <div className="mt-10 pt-6 border-t border-pink-800 text-center">
                  <p className="text-lg text-pink-300 font-cursive">A Minnie Moment: Sunset & Slumber</p>
                </div>
              </div>
            ...
            >
              <div className="flex items-center justify-center mb-4">
                ...
                <h4 className="text-xl font-semibold">N.B: BYOB 🥂🍻</h4>
              </div>
              <p className="text-center text-gray-300">
                Let's toast to life, growth, and everything in between.
              </p>
              <motion.p 
                whileHover={{ scale: 1.05 }}
                className="text-center text-gray-400 italic mt-4 bg-black bg-opacity-30 p-3 rounded-lg"
              >
                "Welcome to Minnie's World, where the vibes are five-star. Even if the chef (me) is still in her cooking class era 😅✨"
              </motion.p>
            </motion.div>
          </motion.div>
        </div>
      ...
      {/* RSVP Section */}
      <section id="rsvp" className="py-16 md:py-24 bg-gradient-to-b from-gray-900 to-black relative overflow-hidden">
        {/* Decorative elements */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            className="text-center mb-12"
          >
            <h2 className="text-3xl md:text-4xl font-bold text-pink-500 mb-6">RSVP</h2>
            <div className="w-24 h-1 bg-pink-500 mx-auto mb-8"></div>
          </motion.div>
          ...
          <div className="max-w-2xl mx-auto">
            ...
            >
              ...
              >
                Please RSVP by April 24, 2025, so we can prepare for your arrival and make sure everything is perfect.
              </motion.p>
              ...
              >
                <svg className="w-8 h-8 text-pink-500 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <p className="text-xl font-semibold">+27 (83) 528-1746</p>
              </motion.div>
              ...
              <div className="flex flex-col md:flex-row gap-6 justify-center mt-8">
                <motion.button 
                  ...
                  whileHover={{ scale: 1.05, boxShadow: "0 0 15px rgba(236, 72, 153, 0.5)" }}
                  whileTap={{ scale: 0.95 }}
                  onClick={() => window.open('tel:+27835281746', '_blank')}
                ...
                <motion.button 
                  ...
                  whileTap={{ scale: 0.95 }}
                  onClick={() => window.open('https://wa.me/27835281746?text=Hi%20Minnie!%20I%20would%20love%20to%20attend%20your%20Sunset%20Soir%C3%A9e%20celebration!', '_blank')}
      ...
      {/* Final Note Section */}
      <section id="note" className="py-16 md:py-24 bg-gradient-to-b from-black to-gray-900 relative overflow-hidden">
        {/* Floating elements */}
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              Thank you for the love, the light, the energy, and for simply being here. Whether you've walked with me through every season or are joining this one fresh, your presence means the world.
            </motion.p>
            ...
            <motion.p 
              ...
              className="text-gray-300 mb-6"
            >
              I can't wait to laugh, eat, dance, and vibe with you under the stars. Your support and love have shaped this moment more than you know.
            </motion.p>
      ...
      <footer className="py-8 bg-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-gray-400">© 2025 | Website by Gresham Tembo</p>
        </div>
      </footer>
...
const AppWithStyles = () => {
  useEffect(() => {
    ...
    link.href = 'https://fonts.googleapis.com/css2?family=Dancing+Script:wght@400;700&family=Poppins:wght@300;400;500;600;700&display=swap';
    link.rel = 'stylesheet';
